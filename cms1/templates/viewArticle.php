<?php include "../cms/templates/include/header.php" ?>
 ...
 <div class="col-xs-12 col-sm-12 tess">
                <?php
                if($_SESSION['url']=='/cms1/travel.php?action=viewArticle&articleId='.$results['article']->id.'&lang='.$_SESSION['lang']){
...
<button type="button" name="like" class='ld-btn-like green' title='I like it'>
<img class='ld-img-like' src="../public/thumbs-up-s.png"/>
</button>
 
<button type="button" name="dislike" class='ld-btn-dislike red' title='I dislike it'>
...
<div class="ya-share2" data-services="vkontakte,facebook,gplus,twitter,blogger,delicious,digg,reddit,evernote,linkedin,pocket,renren,sinaWeibo,surfingbird,tencentWeibo,tumblr,whatsapp" data-counter=""></div>
       ...
       <div class="col-xs-12 col-sm-10 tess3">
      <p><a href="travel.php"><?=Dict::_('RETURN_TO_ARTICLES')?></a></p>
...
if($_SESSION['username']){
  include '../tpl/comment/commenting-travel.php';
  }

   include '../cms/templates/include/footer.php' ;
