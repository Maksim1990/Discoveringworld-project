        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('CINEMAMUSIC')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
   ...
   <ul class="form" >
       ...
       <li class="selected"><a class="logout" href="../tpl/cinema.php?lang=<?=$_SESSION['lang']?>"><i class="icon-signout"></i><?=Dict::_('CINEMAMUSIC')?></a></li>
	</ul>
        </div>
         <div>
             <?php 
...
$query="SELECT * FROM articles_".$_SESSION['lang']." WHERE articleSidebar='cinema'  ORDER BY `publicationDate` DESC ";  
