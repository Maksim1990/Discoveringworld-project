        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('TRADITIONS')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
   ...
   <ul class="form" >
       ...
       <li class="selected"><a href="../tpl/traditions.php?lang=<?=$_SESSION['lang']?>"><i class="icon-envelope-alt"></i><?=Dict::_('TRADITIONS')?></a></li>
...
$query="(SELECT * FROM culture_".$_SESSION['lang']." WHERE articleSidebar='traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='asia,traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='belarus,traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='thailand,traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='west,traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='otherworld,traditions')  ORDER BY `publicationDate` DESC ";  
