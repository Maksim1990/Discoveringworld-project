        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb">
                   ...
                   <li class="active"><?=Dict::_('OTHERWORLD')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
 ...
 <ul class="form" >
       ...
       <li ><a href="../tpl/thailand.php?lang=<?=$_SESSION['lang']?>"><i class="icon-envelope-alt"></i><?=Dict::_('COUNTRY1')?></a></li>
                ...
                <li class="selected"><a class="logout" href="../tpl/otherworld.php?lang=<?=$_SESSION['lang']?>"><i class="icon-signout"></i><?=Dict::_('OTHERWORLD')?></a></li>
	</ul>
        </div>
         <div>
               <?php 
...
$query="(SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='otherworld')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='otherworld,culture')"
