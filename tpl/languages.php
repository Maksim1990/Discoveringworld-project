        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('LANGUAGES')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
     <div class="hidden-xs col-md-2 col-sm-2 ty " >
        <div id="sidebar">
   <ul class="form" >
       <li class="selected"><a class="profile" href="../tpl/languages.php?lang=<?=$_SESSION['lang']?>"><i class="icon-user"></i><?=Dict::_('LANGUAGES')?></a></li>
...
$query="SELECT * FROM culture_".$_SESSION['lang']." WHERE articleSidebar='languages'  ORDER BY `publicationDate` DESC ";  
