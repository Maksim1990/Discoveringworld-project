...
?>     
    ...
    $sql = mysql_query("SELECT * FROM commenting WHERE mark='$mark' AND mark_article='$mark_article'   ORDER BY id DESC ") or die(mysql_error());;
   ...
   $(function(){ 
        ...
        $('.bt-add-com').click(function(){
            ...
            if( !theCom.val()){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "../tpl/comment/ajax/add-comment.php",
