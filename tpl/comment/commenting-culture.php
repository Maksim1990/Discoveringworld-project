...
?>     
    ...
    ?>
    <?php 
       $sql = mysql_query("SELECT * FROM commentingculture WHERE  mark='$mark' AND mark_article='$mark_article'   ORDER BY id DESC ") or die(mysql_error());;
   ...
   $(function(){ 
        ...
        $('.bt-add-com').click(function(){
            ...
            if( !theCom.val()){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "../tpl/comment/ajax/add-comment-culture.php",
