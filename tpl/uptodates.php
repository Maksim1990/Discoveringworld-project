        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('UPTODATES')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
   ...
   <ul class="form" >
       ...
       <li class="selected"><a class="settings" href="../tpl/uptodates.php?lang=<?=$_SESSION['lang']?>"><i class="icon-cog"></i><?=Dict::_('UPTODATES')?></a></li>
...
$query="SELECT * FROM articles_".$_SESSION['lang']." WHERE articleSidebar='uptodates'  ORDER BY `publicationDate` DESC ";  
