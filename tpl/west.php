        ...
        <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('WESTEUROPE')?></li>
               </ul>
            </div>
        </div>  
...
<div class="row">
 ...
 <ul class="form" >
       ...
       <li ><a href="../tpl/thailand.php?lang=<?=$_SESSION['lang']?>"><i class="icon-envelope-alt"></i><?=Dict::_('COUNTRY1')?></a></li>
                ...
                <li class="selected"><a class="logout" href="../tpl/west.php?lang=<?=$_SESSION['lang']?>"><i class="icon-signout"></i><?=Dict::_('WESTEUROPE')?></a></li>
...
$query="(SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='west')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='west,traditions')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='west,culture')  ORDER BY `publicationDate` DESC ";  
