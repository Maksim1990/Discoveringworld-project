         ...
         <div class="row bradcrumps">
            <div class="col-xm-6 col-sm-10 col-sm-offset-2">
                <ul class="breadcrumb" >
                   ...
                   <li class="active"><?=Dict::_('COUNTRY1')?></li>
               </ul>
            </div>
        </div>     
...
<div class="row">
 ...
 <ul class="form" >
       ...
       <li class="selected"><a href="../tpl/thailand.php?lang=<?=$_SESSION['lang']?>"><i class="icon-envelope-alt"></i><?=Dict::_('COUNTRY1')?></a></li>
...
$query="(SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='thailand')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='thailand,culture')"
        ."UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='asia,thailand')"
        . "UNION (SELECT * FROM travel_".$_SESSION['lang']." WHERE articleSidebar='thailand,traditions') ORDER BY `publicationDate` DESC ";  
