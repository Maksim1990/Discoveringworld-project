...
<label for='image1'>".Dict::_('CHANGE_PROF_PIC').":</label>
    ...
    echo  "<div class='col-xs-12 col-sm-10 col-sm-offset-1'><a href='../public/add_as_friend.php?lang=".$_SESSION['lang']."&id=".$link."' class='button hover men'><img src='../public/img/perSent2.png'></a>"
     ...
     echo  "<div class='col-xs-12 col-sm-10 col-sm-offset-1' id='is_friend'><a href='#'  class='button hover men'><img src='../public/img/users.png'></a>"
                 . "<a href='#'>".strtoupper($profileName).Dict::_('IS_YOUR_FRIEND')."</div>";   
     echo  "<div class='col-xs-12 col-sm-10 col-sm-offset-1'><a href='#' class='button del hover men delete_friend'><img src='../public/img/deletePerson.png'></a>"
                 . "<a class='button del delete_friend' id='delete_friend' href='#'> ".Dict::_('DELETE2').strtoupper($profileName).Dict::_('FROM_FRIENDLIST2')."</div>"; 
    }else {
      echo  "<div class='col-xs-12 col-sm-10 col-sm-offset-1 delT'><a href='#' class='button hover men add_as_friend add_as_friend_im '><img src='../public/img/picAdd.png'></a>"
                 . "<a href='#' id='add_as_friend' class='add_as_friend'>".Dict::_('ADD_AS_FRIEND')."</a></div>";        
    }    
    }
...
<label for='image1'>".Dict::_('CHANGE_PROF_PIC')." :</label>
 ...
 echo " <div class='content-comment-1'>
	...
	</p> <br/><span class='buttonStatus' style='display:none;'>   <a name='editS'  class='bt-edit-status'>". Dict::_('EDIT')."</a>   
 ...
 <!--    '../public/add_as_friend.php?lang=".$_SESSION['lang']."&id=".$link."&action2=delete'-->
   ...
   $('.add_as_friend').click(function(){  
         ...
         $.ajax({
                ...
                data:'lang=<?=$_SESSION["lang"];?>&id=<?=$link;?>&action2=add',
                                  beforeSend: function() {
        $('#add_as_friend').text('Loading...');
    },
                success: function(){
          
         $('#add_as_friend').text('<?=Dict::_('FRIEND_REQUEST_SENT');?>');
                    } 
            });
});
   ...
   $('.delete_friend').click(function(){  
            ...
            if(conf){
                ...
                type:"POST",
                url:"add_as_friend.php",
                data:'id=<?=$link?>&action2=delete',
      
            success: function(html){
     
         $('.delete_friend:first').html(html);
          $('#delete_friend,#is_friend').hide();
                    } 
            });
            }
